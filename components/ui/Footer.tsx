      ...
      <div className="mx-auto max-w-7xl px-6 py-8 md:py-10 grid gap-6 md:grid-cols-3 text-sm text-[var(--muted)]">
        ...
        <div>
          ...
          <ul className="mt-2 space-y-1">
            ...
            <li><Link href="/solutions">Software solutions and decision guides</Link></li>
            <li><Link href="/industries">Industry software experience</Link></li>
        ...
        <div>
          ...
          <div className="mt-4 flex items-center gap-2">
            {/* X / Twitter */}
            {/* <a
              href="https://twitter.com/FullstackK88563"
              target="_blank"
            ...
            {/* GitHub */}
            {/* <a
              href="https://github.com/fullstackdev2010"
              target="_blank"
              rel="noopener noreferrer"
