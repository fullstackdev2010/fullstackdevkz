          ...
          <div className="px-6 py-8 md:px-10 md:py-12">
            ...
            <div className="mt-10 space-y-12 text-base leading-relaxed text-[var(--muted)]">
              <Section id="processing-location" title="Where processing happens">
                <p>
                  UNIScan is designed to keep your documents on your device. We do{" "}
              ...
              <Section id="children" title="Children’s privacy">
                <p>UNIScan is a professional utility and not directed to children.</p>
              </Section>
